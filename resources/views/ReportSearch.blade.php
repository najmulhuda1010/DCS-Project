        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{route('report.search')}}" method="post">
                  ...
                  <div class="form-row">
                    <div class="col-md-2 mb-3">
                      ...
                      <input type="date" value="{{ $startDate }}" id="dateFrom" class="form-control" id="Project" name="dateFrom">
                    </div>

                    <div class="col-md-2 mb-3 mt-6">
                      <label class="ml-2" for="dateTo"></label>
                      <input type="date" value="{{ $endDate }}" min="" max="" id="dateTo" class="form-control" id="Project" name="dateTo">
                    </div>
              ...
              @else
              <h4>@lang('report.titile2')</h4>
              <br>
              <center>
                <!-- <a class="btn btn-dark" id class="text-center" href="{{route('report-export')}}">Download</a> -->
                <input type="button" class="btn btn-dark mb-3" onclick="export_data()" value="Export Data">
              </center>
...
<script>
  function export_data() {
    let data = document.getElementById('detailed_table');
    var excel = XLSX.utils.table_to_book(data, {
      sheet: 'sheet1'
    });
    XLSX.write(excel, {
      bookType: 'xlsx',
    ...
    XLSX.writeFile(excel, 'LoanReport.xlsx');
  }
