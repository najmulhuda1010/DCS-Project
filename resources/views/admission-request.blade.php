  ...
  <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      ...
      <div class="d-flex align-items-center flex-wrap mr-2">
        <!--begin::Page Title-->
        <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">@lang('admission.header')</h5>
      </div>
      <!--end::Info-->
    </div>
  </div>
            ...
            <div class="col-md-12">
              ...
              <div class="form_value">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-2 mb-3">
                    <label class="ml-2" for="status">@lang('admission.status')</label>
                ...
                <div class="form-row">
                  ...
                  @endphp
                  <div class="col-md-2 mb-3">
                    <label for="Project" class="form-label">@lang('admission.dateRange')</label>
                    <input type="date" value="<?php echo $today; ?>" class="form-control" id="dateFrom" name="dateFrom">
                  </div>
                  <div class="col-md-2 mb-3 mt-6">
                    <label class="ml-2" for="level"></label>
                ...
                <div class="form-row">
                  <div class="col-md-3 mb-3">
                    <label class="ml-2" for="branch_wise_search">@lang('admission.branchSearch')</label>
                  ...
                  <div class="col-md-2 mb-3">
                    <label for="dateFrom" class="form-label">@lang('admission.dateRange')</label>
                    <input type="date" value="<?php echo $today; ?>" id="dateFrom" class="form-control" id="Project"
                      name="dateFrom">
                  </div>
              ...
              <table style="text-align: center;" class="table table-bordered" id="myTable">
                <thead>
                  <tr class="brac-color">
                    <th>@lang('admission.table_header1')</th>
                    <th>@lang('admission.table_header2')</th>
                    <!-- <th>Enrollment ID</th> -->
                    <th>@lang('admission.table_header3')</th>
                    <th>@lang('admission.table_header4')</th>
                    <th>@lang('admission.table_header5')</th>
                    <th>@lang('admission.table_header7')</th>
                    <th>@lang('admission.table_header6')</th>
                  </tr>
                </thead>
                <tbody>
                </tbody>
...
$(document).ready(function() {
  ...
  fill_datatable();
  // region='' , area= '',
  function fill_datatable(division = '', region = '', area = '', status = '', branch = '', dateFrom = '', dateTo =
    '', po = '') {
    var table = $('#myTable').DataTable({
      ...
      ajax: {
        url: "{{url('operation/admissionTable')}}",
        data: {
          division: division,
          region: region,
          area: area,
