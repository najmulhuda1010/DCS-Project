...
@section('content')
<?php $projectcode =  session('projectcode'); ?>
<input type="hidden" id='projectcode' value="<?php echo $projectcode; ?>">
              ...
              <div class="form_value">
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-2 mb-3">
                    ...
                    <input type="date" value="<?php echo $from_date; ?>" class="form-control" id="dateFrom"
                      name="dateFrom">
                  </div>
                ...
                <div class="form-row">
                  <div class="col-md-2 mb-3">
                    <label for="dateFrom" class="form-label">@lang('admission.dateRange')</label>
                    <input type="date" value="<?php echo $from_date; ?>" id="dateFrom" class="form-control" id="Project"
                      name="dateFrom">
                  </div>

                  <div class="col-md-2 mb-3 mt-6">
                    <label class="ml-2" for="dateTo"></label>
                    <input type="date" value="<?php echo $today; ?>" min="" max="" id="dateTo" class="form-control"
                      id="Project" name="dateTo">
                  </div>
                  <div class="col-md-2 mb-3 mt-8">
                  ...
                  <div class="col-md-3">
                    <div class="card" style="width: 18rem; height: 131;">
                      <div class="card-body" style="background-color:#fed8b1">
                        <h5 class="card-title" style="padding: 0; margin: 0;">@lang('dashboard.card3')</h5>
                        <h5 class="text-center" style="margin-top:7px;" id="total_disbuse">{{ $disburse_amt->sum }}</h5>
                      </div>
                    </div>
                  </div>
                  <div class="col-md-3">
                ...
                <div class="col-md-3" style="margin-top:42px;">
                  <div class=" mb-3">
                    <button type="button" id="pending"
                      class="btn btn-block btn-secondary active">@lang('actionBtn.pending') (<span
                        class="pending_data">{{$all_pending_loan->count}}</span>)</button>
                  </div>
                  <div class=" mb-3">
                    <button type="button" id="approved" class="btn btn-block btn-secondary">@lang('actionBtn.approval')
                      (<span id="approved_data">{{$all_approve_loan->count}}</span>)</button>
                  </div>
                  <div class=" mb-3">
                    <button type="button" id="disbursement"
                      class="btn btn-block btn-secondary">@lang('actionBtn.disbursement') (<span
                        id="disbursement_data">{{$all_disbursement->count}}</span>)</button>
                  </div>
                  <div class=" mb-3">
                    <button type="button" id="disburse" class="btn btn-block btn-secondary">@lang('actionBtn.disburse')
                      (<span id="disburse_data">{{$all_disburse_loan->count}}</span>)</button>
                  </div>
                  <div class=" mb-3">
                    <button type="button" id="rejected" class="btn btn-block btn-secondary">@lang('actionBtn.reject')
                      (<span id="rejected_data">{{$all_reject_loan->count}}</span>)</button>
                  </div>
                </div>
                {{-- datatable*********** --}}
                <div class="col-md-9">
                  <div class="roll_btn">
                    <div class="row">
                      <?php if (session('projectcode') == '015') { ?>
                      <div class="col-md-3">
                        <div class="row">
                          <div class="col-md-4"></div>
                          <div class="col-md-8 roll_single_btn">
                            <h4 class="roll_class" id="roll_bm">@lang('dashboard.role1') <span
                                id="btn_bm">{{$bm_pending_loan->count }}</span>
                            </h4>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-3">
                        <div class="row">
                          ...
                          <div class="col-md-8 roll_single_btn">
                            <h4 class="roll_class" id="roll_am">@lang('dashboard.role2') <span
                                id="btn_am">{{ $am_pending_loan->count }}</span>
                            </h4>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="row">
                          <div class="col-md-4"></div>
                          <div class="col-md-8 roll_single_btn">
                            <h4 class="roll_class" id="roll_rm">@lang('dashboard.role3') <span
                                id="btn_rm">{{$rm_pending_loan->count }}</span>
                            </h4>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="row">
                          <div class="col-md-4"></div>
                          <div class="col-md-8 roll_single_btn">
                            <h4 class="roll_class" id="roll_dm">@lang('dashboard.role4') <span
                                id="btn_dm">{{$dm_pending_loan->count }}</span>
                            </h4>
                          </div>
                        </div>
                      </div>
                  ...
                  <table style="text-align: center;" class="table table-bordered" id="myTable">
                    <thead>
                      <tr class="brac-color">
                        ...
                        <th>@lang('dashboard.header9')</th>
                        <th>@lang('dashboard.header7')</th>
                        <th>@lang('dashboard.header2')</th>
                        <th>@lang('dashboard.header3')</th>
                        <th>@lang('dashboard.header8')</th>
