        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $(`<tr>
                    ...
                    <th>@lang('formConfig.table_header2')</th>
                    <th>@lang('formConfig.table_header3')</th>
                    <th>@lang('formConfig.productname')</th>
                    <th>@lang('formConfig.groupname')</th>
                    <th>@lang('formConfig.pagename')</th>
                    <th>@lang('formConfig.pageno')</th>
                    <th>@lang('formConfig.referencename')</th>
                    <th>@lang('formConfig.table_name')</th>
                    <th>@lang('formConfig.table_header4')</th>
                </tr>`).appendTo("#app-form");
                $.each(data, function(key, value) {
                    if (value.formID == "rca") {
                    ...
                    if (value.columnType == 0 || value.formName == app_form) {
                        ...
                        $("#app-form").append(`<tr>  <td><input type="text" value="` + (value.fieldNameEn || value.lebel.english) + `"
                                                ...
                                                <td><input type="text" value="` + value.dataType + `"
                                                        class="form-control" id="label" name="dataType[]" readonly></td>
                                                <td><input type="text" value="` + value.productname + `"
                                                        class="form-control" id="label" name="productname[]" readonly></td>
                                                <td><input type="text" value="` + value.groupname + `"
                                                        class="form-control" id="label" name="groupname[]" readonly></td> 
                                                <td><input type="text" value="` + value.pagename + `"
                                                        class="form-control" id="label" name="pagename[]" readonly></td> 
                                                <td><input type="text" value="` + value.pageno + `"
                                                        class="form-control" id="label" name="pageno[]" readonly></td> 
                                                <td><input type="text" value="` + value.referencename + `"
                                                        class="form-control" id="label" name="referencename[]" readonly></td> 
                                                <td><input type="text" value="` + value.table_name + `"
                                                        class="form-control" id="label" name="table_name[]" readonly></td> 
                                                <td>
                                                    <select id="status" name="status[]" class="form-control">
                                                        <option selected value='1'>True</option>
                                                        <option value='0'>False</option>
