		...
		<script>
			$(document).ready(function() {
				...
				if (typeof(EventSource) !== "undefined") {
					var source = new EventSource('http://scmtest.brac.net/dcs/Notification');
					source.onmessage = function(event) {
						console.log(event);
						// document.getElementById("result").innerHTML = "6<br>";
						document.getElementById("result").innerHTML = event.data + "<br>";
						document.getElementById("message_que_count").innerHTML = event.data;
					};
				} else {
		...
		<div class="topbar">
			...
			<div class="dropdown">
				...
				<div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
					<div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1 pulse pulse-primary" id="message_ques" onclick="showMessages()">
						<span class="svg-icon svg-icon-primary svg-icon-2x"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
								<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
									<path d="M17,12 L18.5,12 C19.3284271,12 20,12.6715729 20,13.5 C20,14.3284271 19.3284271,15 18.5,15 L5.5,15 C4.67157288,15 4,14.3284271 4,13.5 C4,12.6715729 4.67157288,12 5.5,12 L7,12 L7.5582739,6.97553494 C7.80974924,4.71225688 9.72279394,3 12,3 C14.2772061,3 16.1902508,4.71225688 16.4417261,6.97553494 L17,12 Z" fill="#FB3199" />
									<rect fill="#FB3199" opacity="0.3" x="10" y="16" width="4" height="4" rx="2" />
								</g>
							</svg>
							<!--end::Svg Icon-->
						</span>
						<span id='result' class="badge" style="color:red; margin-left:-15px;margin-top:-17px;"></span>
				...
				<div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
					<form>
						...
						<div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(media/misc/bg-1.jpg)">
							<!--begin::Title-->
							<h4 class="d-flex flex-center rounded-top" style="color:black;">
								<span class="text-white">
									<p style="color:black">User Notifications</p>
								</span>

								<span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2"><span id="message_que_count">0</span> new</span>
							</h4>
							<!--end::Title-->
							<!--begin::Tabs-->
							<ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8" role="tablist">
								{{-- <li class="nav-item">
								<a class="nav-link active show" data-toggle="tab" href="#topbar_notifications_notifications"><p style="color:black">Alerts</p></a>
							</li> --}}
								<li class="nav-item active show">
									<a class="nav-link" data-toggle="tab" href="#topbar_notifications_events">
										<p style="color:black">Alerts</p>
									</a>
								</li>
								{{-- <li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="#topbar_notifications_logs"><p style="color:black">Logs</p></a>
							</li> --}}
							</ul>
							<!--end::Tabs-->
						</div>
						...
						<div class="tab-content">
							...
							<div class="tab-pane active show" id="topbar_notifications_events" role="tabpanel">
								<!--begin::Nav-->
								<div id="message-div" class="navi navi-hover scroll my-4" data-scroll="true" data-height="300" data-mobile-height="200">
									<!--begin::Item-->
									<a href="#" class="navi-item">
										<div class="navi-link">
											<div class="navi-text">
												<div class="font-weight-bold text-primary">New report has been received</div>
			...
			<div class="dropdown">
				...
				<div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
					...
					<ul class="navi navi-hover py-4">
						<!--begin::Item-->
						<li class="navi-item">
							<a href="https://trendx.brac.net/home" class="navi-link btn">Sign out</a>
						</li>
					</ul>
					<!--end::Nav-->
				</div>
