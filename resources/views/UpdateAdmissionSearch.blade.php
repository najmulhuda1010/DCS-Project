                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-xs-12 col-sm-12 offset-md-2">
                            ...
                            <form action="admissionview" method="get">
                                @csrf
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="userID">BranchCode</label>
                                        <input type="text" class="form-control" id="userID" name="branchcode">
                                    </div>

                                    <div class="form-group">
                                        <label for="projectcode">OrgNo</label>
                                        <input type="text" class="form-control" id="projectcode" name="orgno">
                                    </div>
                                    <div class="form-group">
